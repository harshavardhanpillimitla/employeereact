    ...
    render(){
        ...
        return (
            <nav className="navbar navbar-expand-lg navbar-dark bg-primary">
                    ...
                    <Link className="navbar-brand disabled" to="/home">Blog post</Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        ...
                        </React.Fragment> : <React.Fragment><li className="nav-item">
                            <p className="nav-link" onClick={this.onClick}>logout</p>
                        </li>
